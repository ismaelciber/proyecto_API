...
INSERT INTO `peliculas` (`nombre`, `descripcion`, `fecha`, `foto`) VALUES ('Una historia del bronx', 'El distrito de Fordam, en el Bronx, esta dominado por la mafia siciliana. El honesto conductor de autobuses y padre de familia Lorenzo Anello se niega a aceptar sobornos y vive una vida al margen de la mafia. Sin embargo, una noche su hijo de 9 años es testigo de un asesinato cometido por Sonny, el jefe de la mafia.', '1993', 'foto5.jpg');